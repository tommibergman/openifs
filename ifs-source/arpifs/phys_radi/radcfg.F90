...
ASSOCIATE(YDDIM=>YDGEOMETRY%YRDIM,YDDIMV=>YDGEOMETRY%YRDIMV,YDGEM=>YDGEOMETRY%YRGEM, YDMP=>YDGEOMETRY%YRMP, &
 ...
 & YDGSGEOM=>YDGEOMETRY%YRGSGEOM,YDCVER=>YDGEOMETRY%YRCVER, &
 & YDGSGEOM_NB=>YDGEOMETRY%YRGSGEOM_NB, YDLAP=>YDGEOMETRY%YRLAP,  &
 & YDCSGLEG=>YDGEOMETRY%YRCSGLEG, YDSTA=>YDGEOMETRY%YRSTA, &
 & YDVAB=>YDGEOMETRY%YRVAB, YDVETA=>YDGEOMETRY%YRVETA, YDVFE=>YDGEOMETRY%YRVFE, &
  & YDPTRSLB2=>YDMODEL%YRML_DYN%YRPTRSLB2,YDRIP=>YDMODEL%YRML_GCONF%YRRIP,YDERAD=>YDMODEL%YRML_PHY_RAD%YRERAD, &
  & YGFL=>YDMODEL%YRML_GCONF%YGFL,YDDYNA=>YDMODEL%YRML_DYN%YRDYNA)

ASSOCIATE(NAERO=>YGFL%NAERO, NDIM=>YGFL%NDIM, YA=>YGFL%YA, YAERO=>YGFL%YAERO, &
 & YI=>YGFL%YI, YL=>YGFL%YL, YQ=>YGFL%YQ, &
 & NPROMA=>YDDIM%NPROMA, &
 & NFLEVG=>YDDIMV%NFLEVG, &
 & NTSW=>YDERAD%NTSW, &
 & MSLB2VVEL=>YDPTRSLB2%MSLB2VVEL, &
 & NSTART=>YDRIP%NSTART, TDT=>YDRIP%TDT, &
 ...
 & YSP_SL=>YDSURF%YSP_SL, YSP_SLD=>YDSURF%YSP_SLD)
!     ------------------------------------------------------------------
...
CALL GPHPRE(NPROMA,NFLEVG,IST,IEND,YDVAB,YDCVER,PPRE9,PXYB=ZXYB9,PRESF=PPRE9F)
...
CALL RADPAR (YDMODEL, IST,IEND,NPROMA,YSP_SBD%NLEVS,YSP_SGD%NLEVS,KSTGLO,&
 ...
 & PSD_VF(1,YSD_VF%YALUVP%MP),PSD_VF(1,YSD_VF%YALUVD%MP),&
 & PSD_VF(1,YSD_VF%YALNIP%MP),PSD_VF(1,YSD_VF%YALNID%MP),&
 ...
 & PSD_VF(1,YSD_VF%YTVL%MP),PSD_VF(1,YSD_VF%YCO2TYP%MP),PSD_VF(1,YSD_VF%YTVH%MP),&
 & PSD_VF(1,YSD_VF%YCVL%MP)     ,PSD_VF(1,YSD_VF%YCVH%MP),PSD_VF(1,YSD_VF%YCUR%MP),&
 & PSD_VF(1,YSD_VF%YLAIL%MP)    ,PSD_VF(1,YSD_VF%YLAIH%MP),&
 & PSD_VF(1,YSD_VF%YSOTY%MP)    ,&
 & PSD_VF(1,YSD_VF%YSOALUVP%MP) , PSD_VF(1,YSD_VF%YSOALUVD%MP) ,&
 & PSD_VF(1,YSD_VF%YSOALNIP%MP) , PSD_VF(1,YSD_VF%YSOALNID%MP) , &
 & PSD_VF(1,YSD_VF%YGETRL%MP),&
