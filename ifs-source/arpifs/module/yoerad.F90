...
CHARACTER(LEN=500) :: CCMIP_STRAT_FULL, CCMIP_STRAT_FULL_CLIM
LOGICAL :: LSTRATAERO_UPDATED, LCMIP_STRATAER_CMIP6, LCMIP_STRATAER_CMIP7, LCMIP_STRATAER_BCKGD
...
! LECO2TRA:    LOGICAL: .T. IF CO2_GHG TRACER SHOULD BE USED FOR RADIATION FORCING
! ICO2_TRACER: INTEGER: Index of CO2 tracer in GFL to be used in radiation
...
IF (LHOOK) CALL DR_HOOK('YOERAD:PRINT_CONFIGURATION',0,ZHOOK_HANDLE)
IDEPTHLOC = KDEPTH+2
...
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LECO2TRA = ', SELF%LECO2TRA
