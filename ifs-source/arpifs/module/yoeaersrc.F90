...
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'GUSTS = ', SELF%GUSTS
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'DCAL = ', SELF%DCAL
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NOSEASALT = ', SELF%NOSEASALT
