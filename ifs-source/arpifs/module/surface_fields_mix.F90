...
SUBROUTINE FINALISE_SFLP3(YDDYNA,YDSURF,YDSC,YD,LDVERBOSE)
...
SUBROUTINE FINALISE_SFLP2(YDDYNA,YDSURF,YDSC,YD,LDVERBOSE)
...
IF(ALLOCATED(YDSURF%SD_VF)) YDSURF%SD_VF = 0.0_JPRB
