...
REAL(KIND=JPRB) :: RSIGMA_W
REAL(KIND=JPRB) :: RMINCDNC

LOGICAL :: LAERCLIMG, LAERCLIMZ, LAERCLIST, LAERDRYDP, LAERHYGRO, LAERLISI 
LOGICAL :: LAERNGAT , LAERSCAV, LAERSEDIM, LAERSURF , LAERELVS , LAER6SDIA,LAERSEDIMSS
...
! RSIGMA_W   : standard deviation of updraft velocity pdf, used in cloud activation scheme
! RMINCDNC   : minimum in-cloud CDNC [# cm-3]
...
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RSIGMA_W = ', SELF%RSIGMA_W
WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RMINCDNC = ', SELF%RMINCDNC
