...
USE YOMCT0   , ONLY : NCONF, NOUTPUT_XIOS
...
ELSE
  ...
  IF (LXIOS) THEN
    ...
    IF(PRESENT(YDQTYPE)) THEN
      IF (OUTPUT_XIOSFPOS) WRITE(NULOUT, '(''XIOSFPOS: ENTERING XIOS FIELD SENDING PROCEDURES FOR SP FIELDS WTIH YDQTYPE'')')
    ...
    ELSE
      IF (OUTPUT_XIOSFPOS) WRITE(NULOUT, '(''XIOSFPOS: SKIPPTING XIOS FIELD SENDING PROCEDURES FOR SP FIELDS WITHOUT YDQTYPE'')')
