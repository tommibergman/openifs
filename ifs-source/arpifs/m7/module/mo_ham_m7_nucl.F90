...
SUBROUTINE nucl_vehkamaeki(kproma, kbdim,   klev,        & ! ECHAM5 dimensions
  ...
  SUBROUTINE nucl_activation(kproma,kbdim,klev,ph2so4,pforest,ppbl,ppfr,pns)
    ...
    ! W., Saarnio, K., Teinila, K., Kerminen, V.-M., Laaksonen, A., and Lehtinen,
    ! K. E. J.: Connections between atmospheric sulphuric acid and new particle
    ! formation during QUEST III-IV campaigns in Heidelberg and Hyytiala, 
    ...
    ! Riipinen et al., ACP 2007, using Hyytiala QUEST II campaign median.
  ...
  SUBROUTINE nucl_kinetic(kproma,kbdim,klev,ph2so4,pforest,ppbl,ppfr,pns)
    ...
    ! M., Horrak, U., Paatero, J., Hanke, M., and Arnold, F.: Kinetic nucleation
    ! and ions in boreal forest particle formation events, Atmos. Chem. Phys., 4,
    ! 2353-2366, 2004
    !
    ! Sihto, S.-L., Kulmala, M., Kerminen, V.-M., Dal Maso, M., Petaja, T.,
    ...
    ! al., JGR 2008, using Hyytiala QUEST II campaign data (Sihto et al., ACP
