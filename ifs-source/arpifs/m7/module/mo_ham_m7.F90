...
SUBROUTINE m7(kproma, kbdim,   klev, krow, &
  ...
  USE mo_kind,           ONLY: dp
  USE mo_ham_m7ctl,      ONLY: nsnucl, nonucl, lnucl_stat, nwater,iaits,iaccs
...
REAL(dp), OPTIONAL ::   pout_dnuc(kbdim,klev,5)
  ...
  !zout3(1:kproma,KLEV,13)=pm6dry(1:kproma,klev,iaccs)
  do jclass=1,nclass
     zout3(1:kproma,KLEV,jclass)=paernl(1:kproma,klev,jclass)
  end do
  do jn=1,naerocomp
      zout3(1:kproma,KLEV,nclass+jn)=paerml(1:kproma,klev,jn)
   end do
  ...
  END IF
   do jclass=1,nclass
     zout3(1:kproma,KLEV,nclass+naerocomp+jclass)=paernl(1:kproma,klev,jclass)
  end do
  do jn=1,naerocomp
      zout3(1:kproma,KLEV,nclass+naerocomp+nclass+jn)=paerml(1:kproma,klev,jn)
   end do
!zout3(1:kproma,KLEV,14)=pm6dry(1:kproma,klev,iaccs)
!  zout3(1:kproma,KLEV,3)=paernl(1:kproma,klev,iaccs)
  !<<dod
#ifdef HAMMOZ
  !>>dod timers
  IF (ltimer) THEN
  ...
  !-->HK
  !IF (.NOT. ALLOCATED(rwet_m7)) ALLOCATE(rwet_m7(kbdim,klev,nclass))
  !IF (.NOT. ALLOCATED(rdry_m7)) ALLOCATE(rdry_m7(kbdim,klev,nsol))
  !IF (.NOT. ALLOCATED(densaer_m7)) ALLOCATE(densaer_m7(kbdim,klev,nclass))
  !IF (.NOT. ALLOCATED(aerwat_m7)) ALLOCATE(aerwat_m7(kbdim,klev,nclass))

  !!!rwet_m7(1:kproma,:,:) = pm6rp(1:kproma,:,:)/100._dp
  !!!rdry_m7(1:kproma,:,:) = pm6dry(1:kproma,:,:)/100._dp
  !!!densaer_m7(1:kproma,:,:) = prhop(1:kproma,:,:)*1000._dp !eehol: g/cm3 to kg/m3
  !!!aerwat_m7(1:kproma,:,:) = pww(1:kproma,:,:)
  !<--HK
#ifdef HAMMOZ
  !>>dod timers
