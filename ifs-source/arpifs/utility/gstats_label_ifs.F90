...
#ifdef WITH_XIOS
CALL GSTATS_LABEL(2032,'XIO','SUXIOS_INI')
CALL GSTATS_LABEL(2033,'XIO','SUXIOS_FIN')
CALL GSTATS_LABEL(2034,'XIO','SUXIOS_CTXT')
CALL GSTATS_LABEL(2035,'XIO','XIOS_CONTEXT_INI')
CALL GSTATS_LABEL(2036,'XIO','CALENDAR')
CALL GSTATS_LABEL(2037,'XIO','AXES')
CALL GSTATS_LABEL(2038,'XIO','DOMAINS')
CALL GSTATS_LABEL(2039,'XIO','CLOSE_CONTEXT')
CALL GSTATS_LABEL(2040,'XIO','CXIOS_UPDATE_CALENDAR')
CALL GSTATS_LABEL(2041,'XIO','CXIOS_GATHER_FIELDS')
CALL GSTATS_LABEL(2042,'XIO','CXIOS_SEND_FIELDS')
#endif
