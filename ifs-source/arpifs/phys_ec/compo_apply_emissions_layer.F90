...
#ifdef WITH_CPLNG2
IF (ECE_CPL_FESOM_RECOM) CALL ECE_RECOM_GET_FLUXES(KDIM,YDMODEL,PSURF,YDSURF)
IF (ECE_CPL_NEMO_PISCES) CALL ECE_PISCES_GET_FLUXES(KDIM,YDMODEL,PSURF,YDSURF)
IF (ECE_CPL_LPJG_CO2) CALL ECE_LPJG_GET_FLUXES(KDIM,YDMODEL,PSURF,YDSURF)
#endif
