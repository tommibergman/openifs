...
USE YOMCST       , ONLY : RD, RG, RPI, RMSO2, RMSO4
...
REAL(KIND=JPRB) :: ZFSO2(KLON)  , ZFSO4(KLON), ZFSO4_AQ(KLON), ZFSOA(KLON,4)
...
REAL(KIND=JPRB) :: ZSO2(KLON,KLEV), ZTSO2(KLON,KLEV)  , ZTSO4(KLON,KLEV), ZTSO4_AQ(KLON,KLEV)
...
IFLAG=2
CALL SATUR (KIDIA , KFDIA , KLON  , KTDIA , KLEV, LPHYLIN, &
