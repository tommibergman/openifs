SUBROUTINE ECE_UPDCLIE(YDGEOMETRY, YDSURF, PTSTEP)
...
#include "surf_inq.h"
    ...
    IF (LHOOK) CALL DR_HOOK('ECE_UPDCLIE',0,ZHOOK_HANDLE)
    ...
    IF (LHOOK) CALL DR_HOOK('ECE_UPDCLIE',1,ZHOOK_HANDLE)

END SUBROUTINE ECE_UPDCLIE
