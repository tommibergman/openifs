...
SUBROUTINE SURFBC    (YDSURF,KIDIA,KFDIA,KLON,KTILES,KLEVSN,&
 & PTVL   , PCO2TYP, PTVH   ,PSOTY  ,&
 & PSOALUVP, PSOALUVD, PSOALNIP, PSOALNID,&
...
IF(UBOUND(PSOALUVP,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PSOALUVP TOO SHORT!')
ENDIF

IF(UBOUND(PSOALUVD,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PSOALUVD TOO SHORT!')
ENDIF

IF(UBOUND(PSOALNIP,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PSOALNIP TOO SHORT!')
ENDIF

IF(UBOUND(PSOALNID,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PSOALNID TOO SHORT!')
ENDIF
...
IF(UBOUND(PALBF,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PALBF TOO SHORT!')
ENDIF

IF(UBOUND(PALUVP,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PALUVP TOO SHORT!')
ENDIF

IF(UBOUND(PALUVD,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PALUVD TOO SHORT!')
ENDIF

IF(UBOUND(PALNIP,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PALNIP TOO SHORT!')
ENDIF

IF(UBOUND(PALNID,1) < KLON) THEN
  CALL ABORT_SURF('SURFBC: PALNID TOO SHORT!')
ENDIF
